...
func TestRedis_ParseMetrics(t *testing.T) {
	...
	acc.AssertContainsTaggedFields(t, "redis_cluster", fields, tags)
	acc.AssertContainsTaggedFields(t, "redis_cluster_keyspace", keyspaceFields, keyspaceTags)
	...
	acc.AssertContainsTaggedFields(t, "redis_cluster_cmdstat", cmdstatSetFields, cmdstatSetTags)
	...
	acc.AssertContainsTaggedFields(t, "redis_cluster_cmdstat", cmdstatCommandFields, cmdstatCommandTags)
	...
	acc.AssertContainsTaggedFields(t, "redis_cluster_replication", replicationFields, replicationTags)
